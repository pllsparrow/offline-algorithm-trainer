var AlgorithmEditor = (() => {
  ...
  __export(editor_exports, {
    createPythonEditor: () => createPythonEditor
  });
  ...
  var toggleBreakpoint = StateEffect.define();
  var replaceBreakpoints = StateEffect.define();
  var spellingReady = StateEffect.define();
  var SPELLING_EXCLUSIONS = /* @__PURE__ */ new Set([
    "acm",
    "args",
    "argv",
    "async",
    ...
    update(markers, transaction) {
      ...
      for (const effect of transaction.effects) {
        if (effect.is(toggleBreakpoint)) {
          let present = false;
          markers.between(effect.value, effect.value, () => {
            present = true;
          });
  ...
  var whitespaceDecoration = Decoration.mark({ class: "cm-visible-spaces" });
  ...
  var visibleWhitespace = ViewPlugin.fromClass(class {
    constructor(view) {
  ...
  var misspellingDecoration = Decoration.mark({
  ...
  var spellingCheck = ViewPlugin.fromClass(class {
    constructor(view) {
      this.checker = null;
      this.decorations = Decoration.none;
  ...
  var currentLineEffect = StateEffect.define();
  var currentLineState = StateField.define({
    create() {
      return Decoration.none;
    },
  ...
  var pythonHighlightStyle = HighlightStyle.define([
  ...
  function createPythonEditor(parent, options = {}) {
